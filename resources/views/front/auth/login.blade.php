<x-front-guest-layout>
    ...
    <form method="POST" class="bg-white rounded-lg shadow-md p-4" action="{{ route('login') }}">
        ...
        <div class="p-4 px-5">
            ...
            <!-- Email Address -->
            <div class="mt-5">
                <x-input-label for="text" class="mb-3 text-lg" :value="__('Enter your information')" />
                ...
                <x-text-input id="email"
                    ...
                    type="email" name="email" :value="old('email')" placeholder="Fill in email address" required
