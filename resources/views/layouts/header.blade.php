            ...
            <div class="flex items-center">
                <div x-data="{ dropdownOpen: false }" class="relative">
                    <button type="button" @click="dropdownOpen = ! dropdownOpen"
                        ...
                        <img class="h-full w-full object-cover" alt="image"
                            src="{{ asset('assets/images/profile-avatar.png') }}">
                    </button>
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <a href="{{ route('admin.profile.edit') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#221551] hover:text-white">Profiel</a>
                        ...
                        <form method="POST" action="{{ route('admin.logout') }}">
                            ...
                            <a href="{{ route('admin.logout') }}"
                                ...
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#221551] hover:text-white">Log out</a>
                        </form>
                    </div>
                </div>
            </div>
