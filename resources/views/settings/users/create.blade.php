                ...
                <div class="bg-white shadow-md rounded my-6 p-5">
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="flex flex-col space-y-2 mb-3">
                            ...
                            <x-text-input id="hire_date" name="hire_date" type="date" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" :value="old('hire_date')" :max="now()->format('Y-m-d')" autocomplete="bday" />
